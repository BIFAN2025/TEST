...
/**
 * Attaches click handlers to navigation items so that clicking them shows the
 * corresponding section and hides the others. The active nav item gets a
...
function setupNavigation() {
  ...
  navItems.forEach((item) => {
    item.addEventListener('click', () => {
      ...
      // Activate clicked nav item and its section
